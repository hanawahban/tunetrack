  ...
  return (
    <div className="space-y-8">
        ...
        <div className="space-y-5">
          ...
          {canCurate && (
            <div className="flex flex-wrap gap-2">
              <Button variant="outline" size="sm" onClick={() => setEditAlbumOpen(true)}>
                <Pencil /> Edit sleeve
              </Button>
              <Button variant="outline" size="sm" onClick={() => setTrackDialog({ open: true })}>
                <Plus /> Press a track
              </Button>
              <Button
                variant="ghost"
          ...
          <div className="space-y-1.5">
            ...
            {tracks.map((track, i) => (
              <CdTrackRow
                ...
                onSpin={() => handleSpin(track)}
                canCurate={canCurate}
                onEdit={() => setTrackDialog({ open: true, track })}
      ...
      <ConfirmDeleteDialog
        ...
        description={`"${album.title}" and its tracklist will be pulled from the shop for good.`}
